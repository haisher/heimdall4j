 ...
 *
 * <p>The circuit breaker instance is resolved by name from the {@link com.heimdall4j.spring.HeimdallRegistry}.
...
public @interface Heimdall {
     ...
     * Must match a registered name in the {@link com.heimdall4j.spring.HeimdallRegistry}.
     */
    String value();
}
